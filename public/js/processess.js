var processess = {
    ...
    "프린팅장비 세팅 및 출력" : ["3D프린터 프로그램 선택", "노즐 종류", "노즐 사이즈", "원터치 피팅1", "원터치 피팅2", "호스", "Syringe", "Piston", "Etc 1", "Etc 2", "3D 프린팅 후 시편 사진", "비고"],
    "동결융해로 세팅" : ["실험날짜", "실험자명", "시편번호", "장비", "온도(℃)", "습도(%)", "비고"],
    "양생단계" : ["실험날짜", "실험자명", "시편번호", "장비", "온도(℃)", "습도(%)", "양생시간(분)" ,"비고", "양생 후 시편 사진"],
